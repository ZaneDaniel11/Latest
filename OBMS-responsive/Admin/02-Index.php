...
<head>
    ...
    <!-- Style -->
    <link rel="stylesheet" href="Bus_At_Terminal.css">
...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Bus Terminal</h5>
                ...
                <div class="modal-body">
                    <form class="row g-3" action="02-Admin-Bus-At-Terminal/Code.php" method="post">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="cor" placeholder="Enter COR Number">
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3" action="02-Admin-Bus-At-Terminal/Code.php" method="post">
                        ...
                        <div class="col-12">
                            <label for="inputAddress2" class="form-label">COR Number</label>
                            <input type="text" class="form-control" id="cor" name="cor" placeholder="Enter COR Number">
                        </div>
                        <!-- Driver's Name Container -->
                        <div class="col-12">
                            <label for="inputAddress" class="form-label">Driver's Name</label>
    ...
    <div class="Table_Container" style="margin-left: 200px;">
